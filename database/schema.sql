...
-- Includes (Relationship between Course and Content - seemingly redundant if Course_Content has Course_ID, but included for ER compliance)
-- If strictly following ER diagram box 'Includes' with (Course_ID, Content_ID):
